...
fun PlantDetailDescription(viewModel: PlantDetailViewModel) {
    val planet by viewModel.plant.observeAsState()
...
@Composable
fun PlanetDesc(description: String) {
...
fun PlantWatering(wateringInterval: Int) {
    Column(Modifier.fillMaxWidth()) {
        ...
        val wateringInterval = LocalContext.current.resources.getQuantityString(
